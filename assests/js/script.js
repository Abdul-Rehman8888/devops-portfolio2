...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio-Jyotirmay Chowdhury";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["DevOps Engineering", "Cloud Engineering", "Platform Engineering"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();
  ...
  s1.async=true;
  s1.src='https://embed.tawk.to/666ae61c981b6c56477cbf08/1i08p5oeo';
  s1.charset='UTF-8';
...
// End of Tawk.to Live Chat
 ...
 $("#contact-form").submit(function (event) {
    ...
    event.preventDefault();
    emailjs.init("v7Hz0GhcIhXWvDMXp");
